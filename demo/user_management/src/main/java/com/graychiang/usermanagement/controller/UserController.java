package com.graychiang.usermanagement.controller;

import com.graychiang.usermanagement.dto.ChangePasswordForm;
import com.graychiang.usermanagement.entity.Role;
import com.graychiang.usermanagement.entity.User;
import com.graychiang.usermanagement.exception.CustomFieldValidationException;
import com.graychiang.usermanagement.exception.UsernameOrIdNotFound;
import com.graychiang.usermanagement.repository.RoleRepository;
import com.graychiang.usermanagement.service.UserService;
...
//            roles = asList(userRole);
            userRoleList = (List<Role>) roleRepository.findAll();
        }
        userRole = roleRepository.findByName("USER");
//        roles = asList(userRole);
    ...
    public String signupAction(@Valid @ModelAttribute("userForm") User user, BindingResult result, ModelMap model) {
        ...
        if (result.hasErrors()) {
            ...
            try {
                ...
                log.info("===CustomFieldValidationException");
